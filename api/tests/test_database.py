...
from api.db import build_tree, create_goal, delete_goal, get_all_goals, supabase, update_goal
...
class TestTreeBuilding:
    ...
    def test_build_single_node_tree(self):
        ...
        rows = [{"id": "root-1", "parent_id": None, "title": "Root Goal"}]
...
class TestDatabaseOperations:
    ...
    def test_create_goal_success(self, mock_supabase):
        ...
        # Mock Supabase response
        mock_response = MagicMock()
        mock_response.data = [{"id": "new-goal-id", "user_id": "user-123", "title": "New Goal", "parent_id": None}]
    ...
    def test_create_goal_with_parent(self, mock_supabase):
        ...
        mock_response = MagicMock()
        mock_response.data = [{"id": "child-goal-id", "user_id": "user-123", "title": "Child Goal", "parent_id": "parent-id"}]
    ...
    def test_update_goal_success(self, mock_supabase):
        ...
        mock_response = MagicMock()
        mock_response.data = [{"id": "goal-id", "title": "Updated Title", "status": "done"}]
